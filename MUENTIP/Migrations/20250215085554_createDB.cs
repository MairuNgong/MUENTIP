        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ApplyMax = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InterestIn", x => x.Id);
                    table.ForeignKey(
                        name: "FK_InterestIn_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Annoucements_Activities_ActivityId",
                        column: x => x.ActivityId,
                        principalTable: "Activities",
                        principalColumn: "ActivityId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplyOn", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ApplyOn_Activities_ActivityId",
                        column: x => x.ActivityId,
                        principalTable: "Activities",
                        principalColumn: "ActivityId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ParticipateIn", x => x.Id);
                    table.ForeignKey(
                        ...
                        principalColumn: "ActivityId");
                    table.ForeignKey(
                        name: "FK_ParticipateIn_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ActivityTypes_TagName",
                table: "ActivityTypes",
                column: "TagName");

            migrationBuilder.CreateIndex(
                name: "IX_Annoucements_ActivityId",
                table: "Annoucements",
                column: "ActivityId");

            migrationBuilder.CreateIndex(
                name: "IX_ApplyOn_ActivityId",
                table: "ApplyOn",
                column: "ActivityId");

            migrationBuilder.CreateIndex(
                name: "IX_ApplyOn_UserId",
                table: "ApplyOn",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InterestIn_TagName",
                table: "InterestIn",
                column: "TagName");

            migrationBuilder.CreateIndex(
                name: "IX_InterestIn_UserId",
                table: "InterestIn",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_ParticipateIn_ActivityId",
                table: "ParticipateIn",
                column: "ActivityId");

            migrationBuilder.CreateIndex(
                name: "IX_ParticipateIn_UserId",
                table: "ParticipateIn",
                column: "UserId");
        }
