...
class User{
  ...
  function renderHotTag(container, hot_tags) {
    hot_tags.forEach(hot_tag => {
      ...
      link_to_section.textContent = hot_tag.name;
      link_to_section.href = `#${hot_tag.name}-section`;
  ...
  function renderHotTagSection(container, hot_tags) {
    hot_tags.forEach(hot_tag => {
      ...
      hot_tag_section.id = `${hot_tag.name}-section`;
      hot_tag_title.textContent = hot_tag.name;
